...
ActiveRecord::Schema.define(version: 20_200_906_110_155) do
  ...
  create_table 'cars', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8', force: :cascade do |t|
    ...
    t.index ['purchase_id'], name: 'index_cars_on_purchase_id'
  end
  ...
  create_table 'purchases', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index ['park_id'], name: 'index_purchases_on_park_id'
  ...
  add_foreign_key 'cars', 'purchases'
  add_foreign_key 'parks', 'users'
  add_foreign_key 'purchases', 'parks'
